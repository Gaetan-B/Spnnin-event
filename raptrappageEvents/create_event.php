...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (sizeof($validations) === 0) {
        ...
        {
            //echo $connection;
            $query = "INSERT INTO event(nom, adresse, champ_libre, lien_fnac, video_yt, date_debut, date_fin) VALUES('".$_POST['nom']."', '".$_POST['adresse']."', '".$_POST['champ_libre']."', '".$_POST['lien_fnac']."', '".$_POST['video_yt']."', '".$_POST['date_debut']."', '".$_POST['date_fin']."')";
            echo $query;
...
<body>
    ...
    <form action="create_event.php" method="post" class="<?= isset($validations) ? "was-validated" : '' ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label>nom
                <input class="form-control" type="text" name="nom" placeholder="nom" maxlength="50" >
            </label>
        ...
        <div class="form-group">
            <label>Adresse
                <input class="form-control" type="text" name="adresse" placeholder="adresse" maxlength="50" >
            </label>
        ...
        <div class="form-group">
            <label>Champ libre
                <textarea class="form-control" name="champ_libre" maxlength="1000" ></textarea>
            </label>
        ...
        <div class="form-group">
            <label>Lien vers la boutique fnac
                <input type="url" class="form-control" name="lien_fnac" maxlength="1000" ></input>
            </label>
        ...
        <div class="form-group">
            <label>Lien vers la video youtube
                <input type="url" class="form-control" name="video_yt" maxlength="1000" ></input>
            </label>
        ...
        <div class="form-group">
            <label>Date de début
                <input type="date" class="form-control" name="date_debut" maxlength="1000" ></input>
            </label>
        ...
        <div class="form-group">
            <label>Date de fin
                <input type="date" class="form-control" name="date_fin" maxlength="50" ></input>
            </label>
